...
|-------------------------------------- |--------------|----------------------|--------------------------|---------|         
| Up-to-date requirements.txt           | NF           |  Tomas               |   X      | |
| `ML/detect-features`                  | FN           |  both                |   X      | |
| `ML/artifact`                         | NF           |  both                |   X      | |
| `ML/feature`                          | NF           |  Tomas               |   X      | |
| `ML/metric`                           | NF           |  Tomas               |   X      | |
| `ML/metric/extensions`                | FN           |  Tomas               |   X      | |
| `ML/model`                            | NF           |  both                |   X      | |
...
| `ST/datasets/management/save`         | FN           |  Tomas               |   X      | |
| `ST/page/modelling`                   | NF           |  Ryan                |   X      | |
...
| `ST/modelling/pipeline/summary`       | FN           |  Ryan                |   X      | |
| `ST/modelling/pipeline/train`         | FN           |  Ryan                |   X      | |
| `ST/modelling/pipeline/save`          | FN           |  Ryan                |   X      | |
| `ST/page/deployment`                  | FN           |  Ryan                |   X      | |
| `ST/deployment/load`                  | FN           |  Ryan                |   X      | |
| `ST/deployment/predict`               | FN           |  Ryan                |   X      | |

Note: We did most of our coding in a live-share session
